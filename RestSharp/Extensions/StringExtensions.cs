...
namespace RestSharp.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return Regex.Replace(pascalCasedWord, @"([A-Z][a-z]+)([A-Z][a-z]+)", "$1_$2");
        ...
        {
            return Regex.Replace(pascalCasedWord, @"([A-Z][a-z]+)([A-Z][a-z]+)", "$1-$2");
            // return Regex.Replace(
            //    Regex.Replace(
            //        // Regex.Replace(pascalCasedWord, @"([A-Z]+)([A-Z][a-z])", "$1-$2"),
            //        Regex.Replace(pascalCasedWord, @"([A-Z][a-z]+)([A-Z][a-z]+)", "$1-$2"),
            //        @"([a-z\d])([A-Z])",
            //        "$1-$2"),
            //    @"[\value]",
            //    "-");
